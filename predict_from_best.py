...
config_path = "experiment_20220708_071243/config.toml"
config = toml.load(config_path)
checkpoint_path = "experiment_20220708_071243/Green-checkpoint-013-of-100.pth"
...
predict(tiles_dir, mask_dir, tile_size, device, chkpt, batch_size=1)
